...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  void initState() {
    super.initState();
    // Adicionando ouvintes para atualizar a tela e liberar o botão enquanto digita
    _name.addListener(_onTextChanged);
    _email.addListener(_onTextChanged);
    _password.addListener(_onTextChanged);
    _weight.addListener(_onTextChanged);
    _height.addListener(_onTextChanged);
    _age.addListener(_onTextChanged);
  }
  ...
  Future<void> _register() async {
    ...
    try {
      // Pequeno ajuste para aceitar vírgula e transformar em ponto
      ...
      if (ok) {
        ...
        // Se o AuthService retornar false sem disparar erro, mostramos isso
        setState(() => _error = 'Não foi possível completar o cadastro.');
      }
    } catch (e) {
      // AQUI ESTÁ A MUDANÇA: Agora o erro real aparece na tela e no log!
