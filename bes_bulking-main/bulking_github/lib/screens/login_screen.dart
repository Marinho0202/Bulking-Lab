          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Center(child: Text('BL', style: GoogleFonts.inter(fontWeight: FontWeight.w800, fontSize: 20, color: AppColors.bg))),
              ),
              const SizedBox(height: 24),
              Text('Bem-vindo\nde volta!', style: GoogleFonts.inter(fontSize: 28, fontWeight: FontWeight.w800, color: AppColors.textPrimary, height: 1.2)),
